...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'AgencyCountries', fields ['country', 'agency']
        db.create_unique('submissions_agencycountries', ['country_id', 'agency_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'AgencyCountries', fields ['country', 'agency']
        db.delete_unique('submissions_agencycountries', ['country_id', 'agency_id'])
