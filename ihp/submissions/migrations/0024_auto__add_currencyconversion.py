...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CurrencyConversion'
        db.create_table('submissions_currencyconversion', (
        ...
        db.send_create_signal('submissions', ['CurrencyConversion'])


    def backwards(self, orm):
        
        # Deleting model 'CurrencyConversion'
        db.delete_table('submissions_currencyconversion')
    ...
    models = {
        ...
        'submissions.currencyconversion': {
            'Meta': {'object_name': 'CurrencyConversion'},
