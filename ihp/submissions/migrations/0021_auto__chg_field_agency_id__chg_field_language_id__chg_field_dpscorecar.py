...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Agency.id'
        db.alter_column('submissions_agency', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Language.id'
        db.alter_column('submissions_language', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'DPScorecardRatings.id'
        db.alter_column('submissions_dpscorecardratings', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'AgencyWorkingDraft.id'
        db.alter_column('submissions_agencyworkingdraft', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'GovScorecardRatings.id'
        db.alter_column('submissions_govscorecardratings', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'CountryTargets.id'
        db.alter_column('submissions_countrytargets', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Country.id'
        db.alter_column('submissions_country', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'CountryExclusion.id'
        db.alter_column('submissions_countryexclusion', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'CountryWorkingDraft.id'
        db.alter_column('submissions_countryworkingdraft', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'AgencyTargets.id'
        db.alter_column('submissions_agencytargets', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Submission.id'
        db.alter_column('submissions_submission', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'MDGData.id'
        db.alter_column('submissions_mdgdata', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'GovScorecardComments.id'
        db.alter_column('submissions_govscorecardcomments', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'AgencyProfile.id'
        db.alter_column('submissions_agencyprofile', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'DPQuestion.id'
        db.alter_column('submissions_dpquestion', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'DPScorecardSummary.id'
        db.alter_column('submissions_dpscorecardsummary', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Country8DPFix.id'
        db.alter_column('submissions_country8dpfix', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'CountryScorecardOverrideComments.id'
        db.alter_column('submissions_countryscorecardoverridecomments', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'AgencyCountries.id'
        db.alter_column('submissions_agencycountries', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'NotApplicable.id'
        db.alter_column('submissions_notapplicable', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'GovQuestion.id'
        db.alter_column('submissions_govquestion', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'DPScorecardComments.id'
        db.alter_column('submissions_dpscorecardcomments', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))


    def backwards(self, orm):
        
        # Changing field 'Agency.id'
        db.alter_column('submissions_agency', 'id', self.gf('django.db.models.fields.AutoField')(auto_created=True, primary_key=True))

        # Changing field 'Language.id'
        db.alter_column('submissions_language', 'id', self.gf('django.db.models.fields.AutoField')(auto_created=True, primary_key=True))

        # Changing field 'DPScorecardRatings.id'
        db.alter_column('submissions_dpscorecardratings', 'id', self.gf('django.db.models.fields.AutoField')(auto_created=True, primary_key=True))

        # Changing field 'AgencyWorkingDraft.id'
        db.alter_column('submissions_agencyworkingdraft', 'id', self.gf('django.db.models.fields.AutoField')(auto_created=True, primary_key=True))

        # Changing field 'GovScorecardRatings.id'
        db.alter_column('submissions_govscorecardratings', 'id', self.gf('django.db.models.fields.AutoField')(auto_created=True, primary_key=True))

        # Changing field 'CountryTargets.id'
        db.alter_column('submissions_countrytargets', 'id', self.gf('django.db.models.fields.AutoField')(auto_created=True, primary_key=True))

        # Changing field 'Country.id'
        db.alter_column('submissions_country', 'id', self.gf('django.db.models.fields.AutoField')(auto_created=True, primary_key=True))

        # Changing field 'CountryExclusion.id'
        db.alter_column('submissions_countryexclusion', 'id', self.gf('django.db.models.fields.AutoField')(auto_created=True, primary_key=True))

        # Changing field 'CountryWorkingDraft.id'
        db.alter_column('submissions_countryworkingdraft', 'id', self.gf('django.db.models.fields.AutoField')(auto_created=True, primary_key=True))

        # Changing field 'AgencyTargets.id'
        db.alter_column('submissions_agencytargets', 'id', self.gf('django.db.models.fields.AutoField')(auto_created=True, primary_key=True))

        # Changing field 'Submission.id'
        db.alter_column('submissions_submission', 'id', self.gf('django.db.models.fields.AutoField')(auto_created=True, primary_key=True))

        # Changing field 'MDGData.id'
        db.alter_column('submissions_mdgdata', 'id', self.gf('django.db.models.fields.AutoField')(auto_created=True, primary_key=True))

        # Changing field 'GovScorecardComments.id'
        db.alter_column('submissions_govscorecardcomments', 'id', self.gf('django.db.models.fields.AutoField')(auto_created=True, primary_key=True))

        # Changing field 'AgencyProfile.id'
        db.alter_column('submissions_agencyprofile', 'id', self.gf('django.db.models.fields.AutoField')(auto_created=True, primary_key=True))

        # Changing field 'DPQuestion.id'
        db.alter_column('submissions_dpquestion', 'id', self.gf('django.db.models.fields.AutoField')(auto_created=True, primary_key=True))

        # Changing field 'DPScorecardSummary.id'
        db.alter_column('submissions_dpscorecardsummary', 'id', self.gf('django.db.models.fields.AutoField')(auto_created=True, primary_key=True))

        # Changing field 'Country8DPFix.id'
        db.alter_column('submissions_country8dpfix', 'id', self.gf('django.db.models.fields.AutoField')(auto_created=True, primary_key=True))

        # Changing field 'CountryScorecardOverrideComments.id'
        db.alter_column('submissions_countryscorecardoverridecomments', 'id', self.gf('django.db.models.fields.AutoField')(auto_created=True, primary_key=True))

        # Changing field 'AgencyCountries.id'
        db.alter_column('submissions_agencycountries', 'id', self.gf('django.db.models.fields.AutoField')(auto_created=True, primary_key=True))

        # Changing field 'NotApplicable.id'
        db.alter_column('submissions_notapplicable', 'id', self.gf('django.db.models.fields.AutoField')(auto_created=True, primary_key=True))

        # Changing field 'GovQuestion.id'
        db.alter_column('submissions_govquestion', 'id', self.gf('django.db.models.fields.AutoField')(auto_created=True, primary_key=True))

        # Changing field 'DPScorecardComments.id'
        db.alter_column('submissions_dpscorecardcomments', 'id', self.gf('django.db.models.fields.AutoField')(auto_created=True, primary_key=True))
